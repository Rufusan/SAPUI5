...
sap.ui.define([
		...
		return BaseController.extend("opensap.soviewer.SalesOrderViewer.controller.Detail", {
		    ...
		    onExpand: function(){
		    	//if (!this.initialized) {
		            ...
		            this.map = new google.maps.Map(this.getView().byId("map").getDomRef(), mapOptions);
		        
			        var map = this.map,
			        	address = this.getView().byId("partnerAddress").getProperty("text"),
			        	postalCode = this.getView().byId("partnerPostalCode").getProperty("text"),
			        	city = this.getView().byId("partnerCity").getProperty("text"),
