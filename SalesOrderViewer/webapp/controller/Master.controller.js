...
sap.ui.define([
		...
		return BaseController.extend("opensap.soviewer.SalesOrderViewer.controller.Master", {
			...
			onOpenViewSettings : function (oEvent) {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("opensap.soviewer.SalesOrderViewer.view.ViewSettingsDialog", this);
